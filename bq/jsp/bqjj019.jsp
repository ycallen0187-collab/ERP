...
<%
	...
	String formTarget = "bqjj019_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj019List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj019Tab"  style="height:100%">
<iframe name="bqjj019_<%=sessionId%>" id="bqjj019Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj019List.jsp"></iframe>
</div>
</de:form>
