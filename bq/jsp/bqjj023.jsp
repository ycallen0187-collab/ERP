...
<%
	...
	String formTarget = "bqjj023_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj023List.jsp?_sessionId="+sessionId ;
%>
...
<de:form action="<%=formAction%>" target="<%=formTarget%>">
	<tr>
        ...
        <td width="22%" class="light-bg-left">
...
<div id="bqjj023Tab"  style="height:100%">
<iframe name="bqjj023_<%=sessionId%>" id="bqjj023Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj023List.jsp"></iframe>
</div>
</de:form>
