...
<div class="phone">
  <div class="topbar">
    <div class="topbar-row">
      ...
      <span class="topbar-title">TR營運總覽</span>
    ...
    <div class="tabs">
      ...
      <button class="tab" onclick="switchTab('105')">105廠</button>
      <button class="tab" onclick="switchTab('108')">108廠</button>
      <button class="tab" onclick="switchTab('109')">109廠</button>
    </div>
  </div>

  <div id="tab-order" class="tab-content active">
    <jsp:include page="bqjj051_tabOrder.jsp" />
  </div>
  <div id="tab-105" class="tab-content"></div>
  <div id="tab-108" class="tab-content"></div>
  <div id="tab-109" class="tab-content"></div>
</div>

<script>
/* 【修正 2】將 tabsList 陣列順序調整與 HTML 上的 Button 標籤完全一致 */
const tabsList = ['order','105', '108', '109'];
...
async function switchTab(name) {
  ...
  if (targetTabContent.innerHTML.trim() === '') {
    try {
      let targetUrl = '';
      if (name === '108') targetUrl = '/erp/bq/jsp/bqjj051_tab108.jsp?updateDate=<%= updateDate %>';
      else if (name === '109') targetUrl = '/erp/bq/jsp/bqjj051_tab109.jsp?updateDate=<%= updateDate %>';
      else if (name === '105') targetUrl = '/erp/bq/jsp/bqjj051_tab105.jsp?updateDate=<%= updateDate %>';
