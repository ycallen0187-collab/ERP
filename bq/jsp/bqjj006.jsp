...
<%
	...
	String formTarget = "bqjj006_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj006List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj006Tab"  style="height:100%">
<iframe name="bqjj006_<%=sessionId%>" id="bqjj006Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj006List.jsp"></iframe>
</div>
</de:form>
