      ...
      <div class="dual-header-container">
        ...
        <div class="dual-header-vals">
          <div class="dual-val-box">
            ...
            <div><span class="item-val" style="color: #000;"><%= aaTool.format(orderData.get("SALESQTY"),"#,##0") %></span><span class="item-unit">噸</span></div>
          </div>
          <div class="dual-val-box">
            <div class="item-label" style="color: #333;">本月出貨</div>
            <div><span class="item-val" style="color: #000;"><%= aaTool.format(orderData.get("SHIPQTY"),"#,##0") %></span><span class="item-unit">噸</span></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="tr-sales-details" class="details-content">
      ...
      <div class="detail-group" style="border-top: none;">
        <div class="detail-group-header">
          ...
          <div class="col-right" style="font-size: 15px; font-weight: 900; color: #333; background: #fffaf9; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("內銷管_銷貨量"),"#,##0") %> <span style="font-size: 12px; font-weight: 700; color: #666;">噸</span></div>
          <div class="col-right" style="font-size: 15px; font-weight: 900; color: #333; background: #f5f9ff; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("內銷管_出貨量"),"#,##0") %> <span style="font-size: 12px; font-weight: 700; color: #666;">噸</span></div>
        </div>
        <div class="detail-grid">
          <div class="detail-row">
            <span class="col-left">P：</span>
            <span class="detail-row-val col-right" style="color: #222; background: #fffaf9; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("內銷配管_銷貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
            <span class="detail-row-val col-right" style="color: #222; background: #f5f9ff; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("內銷配管_出貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
          </div>
          <div class="detail-row">
            <span class="col-left">T：</span>
            <span class="detail-row-val col-right" style="color: #222; background: #fffaf9; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("內銷構造管_銷貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
            <span class="detail-row-val col-right" style="color: #222; background: #f5f9ff; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("內銷構造管_出貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
          </div>
          <div class="detail-row">
            <span class="col-left">F/L：</span>
            <span class="detail-row-val col-right" style="color: #222; background: #fffaf9; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("內銷角扁鐵_銷貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
            <span class="detail-row-val col-right" style="color: #222; background: #f5f9ff; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("內銷角扁鐵_出貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
          </div>
        </div>
      </div>
      ...
      <div class="detail-group">
        <div class="detail-group-header">
          ...
          <div class="col-right" style="font-size: 15px; font-weight: 900; color: #333; background: #fffaf9; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("外銷管_銷貨量"),"#,##0") %> <span style="font-size: 12px; font-weight: 700; color: #666;">噸</span></div>
          <div class="col-right" style="font-size: 15px; font-weight: 900; color: #333; background: #f5f9ff; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("外銷管_出貨量"),"#,##0") %> <span style="font-size: 12px; font-weight: 700; color: #666;">噸</span></div>
        </div>
        <div class="detail-grid">
          <div class="detail-row">
            <span class="col-left">P：</span>
            <span class="detail-row-val col-right" style="color: #222; background: #fffaf9; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("外銷配管_銷貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
            <span class="detail-row-val col-right" style="color: #222; background: #f5f9ff; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("外銷配管_出貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
          </div>
          <div class="detail-row">
            <span class="col-left">T：</span>
            <span class="detail-row-val col-right" style="color: #222; background: #fffaf9; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("外銷構造管_銷貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
            <span class="detail-row-val col-right" style="color: #222; background: #f5f9ff; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("外銷構造管_出貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
          </div>
          <div class="detail-row">
            <span class="col-left">F/L：</span>
            <span class="detail-row-val col-right" style="color: #222; background: #fffaf9; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("外銷角扁鐵_銷貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
            <span class="detail-row-val col-right" style="color: #222; background: #f5f9ff; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("外銷角扁鐵_出貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
          </div>
        </div>
      </div>
      ...
      <div class="detail-group">
        <div class="detail-group-header">
          ...
          <div class="col-right" style="font-size: 15px; font-weight: 900; color: #333; background: #fffaf9; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("C/S_銷貨量"),"#,##0") %> <span style="font-size: 12px; font-weight: 700; color: #666;">噸</span></div>
          <div class="col-right" style="font-size: 15px; font-weight: 900; color: #333; background: #f5f9ff; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("C/S_出貨量"),"#,##0") %> <span style="font-size: 12px; font-weight: 700; color: #666;">噸</span></div>
        </div>
        <div class="detail-grid">
          <div class="detail-row">
            <span class="col-left">CR_C/S：</span>
            <span class="detail-row-val col-right" style="color: #222; background: #fffaf9; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("CR_C/S_銷貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
            <span class="detail-row-val col-right" style="color: #222; background: #f5f9ff; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("CR_C/S_出貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
          </div>
          <div class="detail-row">
            <span class="col-left">HR_C/S：</span>
            <span class="detail-row-val col-right" style="color: #222; background: #fffaf9; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("HR_C/S_銷貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
            <span class="detail-row-val col-right" style="color: #222; background: #f5f9ff; border-radius: 4px; padding: 2px 8px;"><%= aaTool.format(orderData.get("HR_C/S_出貨量"),"#,##0") %> <span style="font-size: 11px; font-weight: 700; color: #666;">噸</span></span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="toggle-header" onclick="toggleOrderDetails('tr-target-details', 'tr-target-icon')" style="padding: 18px 16px;">
      <div class="dual-header-container">
        ...
        <div style="display:flex; align-items:baseline;">
          <span class="item-val" style="color: #000;"><%= aaTool.format(orderData.get("本月_出貨目標"),"#,##0") %></span>
    ...
    <div id="tr-target-details" class="details-content" style="background: #f9f9fb;">
      <div class="target-table" style="border-top: 1px solid #d1d1d6;">
        ...
        <div class="target-row" onclick="toggleSubDetails('tr-sub-dom-details', 'tr-sub-dom-icon', event)" style="cursor: pointer; background: #ffffff;">
          ...
          <div class="target-cell-val"><%= aaTool.format(orderData.get("內銷管_出貨量"),"#,##0") %></div>
          <div class="target-cell-target"> <%= aaTool.format(orderData.get("內銷管_出貨目標"),"#,##0") %></div>
        ...
        <div id="tr-sub-dom-details" class="details-content" style="background: #f4f5f7;">
          <div class="target-row" style="border-top: 1px solid #e5e5ea; padding: 8px 14px; font-size: 14px;">
            ...
            <div class="target-cell-val" style="font-size:14px; color:#555;"><%= aaTool.format(orderData.get("內銷配管_出貨量"),"#,##0") %></div>
            <div class="target-cell-target" style="font-size:14px; background:none; color:#0056b3;"><%= aaTool.format(orderData.get("內銷配管_出貨目標"),"#,##0") %></div>
          ...
          <div class="target-row" style="border-top: 1px solid #e5e5ea; padding: 8px 14px; font-size: 14px;">
            ...
            <div class="target-cell-val" style="font-size:14px; color:#555;"><%= aaTool.format(orderData.get("內銷構造管_出貨量"),"#,##0") %></div>
            <div class="target-cell-target" style="font-size:14px; background:none; color:#0056b3;"><%= aaTool.format(orderData.get("內銷構造管_出貨目標"),"#,##0") %></div>
          ...
          <div class="target-row" style="border-top: 1px solid #e5e5ea; padding: 8px 14px; font-size: 14px;">
            ...
            <div class="target-cell-val" style="font-size:14px; color:#555;"><%= aaTool.format(orderData.get("內銷角扁鐵_出貨量"),"#,##0") %></div>
            <div class="target-cell-target" style="font-size:14px; background:none; color:#0056b3;"><%= aaTool.format(orderData.get("內銷角扁鐵_出貨目標"),"#,##0") %></div>
        ...
        <div class="target-row" onclick="toggleSubDetails('tr-sub-exp-details', 'tr-sub-exp-icon', event)" style="cursor: pointer; background: #ffffff;">
          ...
          <div class="target-cell-val"><%= aaTool.format(orderData.get("外銷管_出貨量"),"#,##0") %></div>
          <div class="target-cell-target"> <%= aaTool.format(orderData.get("外銷管_出貨目標"),"#,##0") %></div>
        ...
        <div id="tr-sub-exp-details" class="details-content" style="background: #f4f5f7;">
          <div class="target-row" style="border-top: 1px solid #e5e5ea; padding: 8px 14px; font-size: 14px;">
            <div class="target-cell-name" style="padding-left: 20px; font-weight: normal; color: #555;">P</div>
            <div class="target-cell-val" style="font-size:14px; color:#555;"><%= aaTool.format(orderData.get("外銷配管_出貨量"),"#,##0") %></div>
            <div class="target-cell-target" style="font-size:14px; background:none; color:#0056b3;"><%= aaTool.format(orderData.get("外銷配管_出貨目標"),"#,##0") %></div>
            <div class="target-cell-rate text-amber" style="font-size:14px;"><%= aaTool.format(orderData.get("外銷配管_出貨達標率"),"#,##0.0") %>%</div>
          </div>
          <div class="target-row" style="border-top: 1px solid #e5e5ea; padding: 8px 14px; font-size: 14px;">
            <div class="target-cell-name" style="padding-left: 20px; font-weight: normal; color: #555;">T</div>
            <div class="target-cell-val" style="font-size:14px; color:#555;"><%= aaTool.format(orderData.get("外銷構造管_出貨量"),"#,##0") %></div>
            <div class="target-cell-target" style="font-size:14px; background:none; color:#0056b3;"><%= aaTool.format(orderData.get("外銷構造管_出貨目標"),"#,##0") %></div>
            <div class="target-cell-rate text-amber" style="font-size:14px;"><%= aaTool.format(orderData.get("外銷構造管_出貨達標率"),"#,##0.0") %>%</div>
          </div>
          <div class="target-row" style="border-top: 1px solid #e5e5ea; padding: 8px 14px; font-size: 14px;">
            <div class="target-cell-name" style="padding-left: 20px; font-weight: normal; color: #555;">F/L</div>
            <div class="target-cell-val" style="font-size:14px; color:#555;"><%= aaTool.format(orderData.get("外銷角扁鐵_出貨量"),"#,##0") %></div>
            <div class="target-cell-target" style="font-size:14px; background:none; color:#0056b3;"><%= aaTool.format(orderData.get("外銷角扁鐵_出貨目標"),"#,##0") %></div>
        ...
        <div class="target-row" onclick="toggleSubDetails('tr-sub-flat-details', 'tr-sub-flat-icon', event)" style="cursor: pointer; background: #ffffff;">
          ...
          <div class="target-cell-val"><%= aaTool.format(orderData.get("C/S_出貨量"),"#,##0") %></div>
          <div class="target-cell-target"><%= aaTool.format(orderData.get("板捲_出貨目標"),"#,##0") %></div>
        ...
        <div id="tr-sub-flat-details" class="details-content" style="background: #f4f5f7;">
          <div class="target-row" style="border-top: 1px solid #e5e5ea; padding: 8px 14px; font-size: 14px;">
            ...
            <div class="target-cell-val" style="font-size:14px; color:#555;"><%= aaTool.format(orderData.get("CR_C/S_出貨量"),"#,##0") %></div>
            <div class="target-cell-target" style="font-size:14px; background:none; color:#0056b3;"><%= aaTool.format(orderData.get("CR板捲_出貨目標"),"#,##0") %></div>
          ...
          <div class="target-row" style="border-top: 1px solid #e5e5ea; padding: 8px 14px; font-size: 14px;">
            ...
            <div class="target-cell-val" style="font-size:14px; color:#555;"><%= aaTool.format(orderData.get("HR_C/S_出貨量"),"#,##0") %></div>
            <div class="target-cell-target" style="font-size:14px; background:none; color:#0056b3;"><%= aaTool.format(orderData.get("HR板捲_出貨目標"),"#,##0") %></div>
...
<%}%>
  ...
  <div class="grid-card" style="border-radius: 16px;">
    <div style="padding: 18px 16px;">
      ...
      <div style="display:flex; align-items:baseline;">
        <span class="item-val" style="font-size: 38px; color: #000;"><%= aaTool.format(orderData.get("ORDERQTY"),"#,##0") %></span>
        ...
        <span class="<%= rateOrderAll >= 100.0 ? "text-red" : "text-green" %>" style="font-size: 20px; font-weight: 900; margin-left: 12px;">
          <%= aaTool.format(orderData.get("ORD_RATE"),"#,##0") %>%
        </span>
    ...
    <div style="background: #f9f9fb; border-top: 1px solid #d1d1d6; display: grid; grid-template-columns: 1fr 1fr 1fr;">
      <div style="padding: 14px 4px; text-align: center; border-right: 1px solid #d1d1d6;">
        ...
        <div style="font-size: 22px; font-weight: 900; color: #000;"><%= aaTool.format(orderData.get("內銷管累計接單重"),"#,##0") %><span style="font-size:12px; font-weight:700; color:#666;">噸</span></div>
      </div>
      <div style="padding: 14px 4px; text-align: center;">
        ...
        <div style="font-size: 22px; font-weight: 900; color: #000;"><%= aaTool.format(orderData.get("ORDQTY_EXP_LONG"),"#,##0") %><span style="font-size:12px; font-weight:700; color:#666;">噸</span></div>
      </div>
      <div style="padding: 14px 4px; text-align: center; border-right: 1px solid #d1d1d6;">
        <div style="font-size: 14px; font-weight: 700; color: #333; margin-bottom: 4px;">
                板捲 <span class="<%= rateFlat >= 100.0 ? "text-red" : "text-green" %>"><%= aaTool.format(orderData.get("ORDQTY_FLAT_RATE"),"#,###") %>%</span>
        </div>
        <div style="font-size: 22px; font-weight: 900; color: #000;"><%= aaTool.format(orderData.get("ORDQTY_FLAT"),"#,##0") %><span style="font-size:12px; font-weight:700; color:#666;">噸</span></div>
      </div>
  ...
  <div class="grid-card">
    <div class="toggle-header" onclick="toggleOrderDetails('tr-pending-details', 'tr-pending-icon')" style="padding: 20px 16px; display: flex; justify-content: space-between; align-items: center; background: #fff0ef;">
      ...
      <div><span class="item-val" style="color: #d32f2f;"><%= aaTool.format(orderData.get("UNDERWET"),"#,##0") %></span><span class="item-unit" style="color: #d32f2f;">噸</span></div>
    </div>
    ...
    <div id="tr-pending-details" class="details-content">
      <div class="detail-group">
        <div class="detail-group-header" style="justify-content: flex-start; gap: 16px;">
          ...
          <div class="col-right" style="font-size: 15px; font-weight: 900; color: #d32f2f; flex: none; white-space: nowrap; margin-left: auto;">
            <%= aaTool.format(orderData.get("內銷管_未交重"),"#,##0") %> 
            <span style="font-size: 12px; font-weight: 700; color: #666;">噸</span></div>
        </div>
        <div class="detail-grid" style="grid-template-columns: 1fr 1fr;">
          <div class="detail-row"><span>P：</span><span class="detail-row-val" style="color: #222; white-space: nowrap;"><%= aaTool.format(orderData.get("內銷_P_未交重"),"#,##0") %> 噸</span></div>
          <div class="detail-row"><span>T_O：</span><span class="detail-row-val" style="color: #222; white-space: nowrap;"><%= aaTool.format(orderData.get("內銷_T_O_未交重"),"#,##0") %> 噸</span></div>
          <div class="detail-row"><span>T_口：</span><span class="detail-row-val" style="color: #222; white-space: nowrap;"><%= aaTool.format(orderData.get("內銷_T_口_未交重"),"#,##0") %> 噸</span></div>
          <div class="detail-row"><span>F/L：</span><span class="detail-row-val" style="color: #222; white-space: nowrap;"><%= aaTool.format(orderData.get("內銷_FL_未交重"),"#,##0") %> 噸</span></div>
        </div>
      </div>
      ...
      <div class="detail-group">
        <div class="detail-group-header" style="justify-content: flex-start; gap: 16px;">
          ...
          <div class="col-right" style="font-size: 15px; font-weight: 900; color: #d32f2f;">
            <%= aaTool.format(orderData.get("外銷管_未交重"),"#,##0") %> 
            <span style="font-size: 12px; font-weight: 700; color: #666;">噸</span></div>
        </div>
        <div class="detail-grid" style="grid-template-columns: 1fr 1fr;">
          <div class="detail-row"><span>P：</span><span class="detail-row-val" style="color: #222;white-space: nowrap;"><%= aaTool.format(orderData.get("外銷_P_未交重"),"#,##0") %> 噸</span></div>
          <div class="detail-row"><span>T_O：</span><span class="detail-row-val" style="color: #222;white-space: nowrap;"><%= aaTool.format(orderData.get("外銷_T_O_未交重"),"#,##0") %> 噸</span></div>
          <div class="detail-row"><span>T_口：</span><span class="detail-row-val" style="color: #222;white-space: nowrap;"><%= aaTool.format(orderData.get("外銷_T_口_未交重"),"#,##0") %> 噸</span></div>
          <div class="detail-row"><span>F/L：</span><span class="detail-row-val" style="color: #222;white-space: nowrap;"><%= aaTool.format(orderData.get("外銷_FL_未交重"),"#,##0") %> 噸</span></div>
        </div>
      </div>
      ...
      <div class="detail-group">
        <div class="detail-group-header" style="justify-content: flex-start; gap: 16px;">
          <div class="detail-title col-left" style="color: #333;">板捲 </div>
          <div class="col-right" style="font-size: 15px; font-weight: 900; color: #d32f2f;">
            <%= aaTool.format(orderData.get("板捲_未交重"),"#,##0") %> 
            <span style="font-size: 12px; font-weight: 700; color: #666;">噸</span></div>
        </div>
        <div class="detail-grid" style="grid-template-columns: 1fr 1fr;">
          <div class="detail-row"><span>CR_C/S：</span><span class="detail-row-val" style="color: #222;white-space: nowrap;"><%= aaTool.format(orderData.get("CR_板捲_未交重"),"#,##0") %> 噸</span></div>
          <div class="detail-row"><span>HR_C/S：</span><span class="detail-row-val" style="color: #222;white-space: nowrap;"><%= aaTool.format(orderData.get("HR_板捲_未交重"),"#,##0") %> 噸</span></div>
        </div>
      </div>
      ...
      <div style="padding: 18px 16px; background: #ebf5ff; border-top: 1px solid #d1d1d6;">
        ...
        <div class="detail-grid" style="color: #444; grid-template-columns: 1fr 1fr;">
          <div class="detail-row"><span>P：</span><span style="font-size: 15px; font-weight: 900; color: #0056b3;white-space: nowrap;">
	        <%= aaTool.format(aaTool.getBigDecimal(orderData.get("內銷_P_未交重")).add(aaTool.getBigDecimal(orderData.get("外銷_P_未交重"))),"#,##0") %>
  ...
  <div class="grid-card">
    <div class="grid-row">
      <div class="grid-item grid-item-border-right grid-item-border-bottom">
        ...
        <div><span class="item-val" style="color: #000;"><%= aaTool.format(invData.get("原料庫存"),"#,##0")%></span><span class="item-unit">噸</span></div>
      </div>
      <div class="grid-item grid-item-border-bottom">
        <div class="item-label">管/型鋼成品庫存</div>
        <div><span class="item-val" style="color: #000;"><%= aaTool.format(invData.get("成品庫存"),"#,##0")%></span><span class="item-unit">噸</span></div>
      </div>
    </div>
    <div class="grid-row">
      <div class="grid-item grid-item-border-right">
        <div class="item-label">鋼廠未交</div>
        <div><span class="item-val" style="color: #000;"><%= aaTool.format(invData.get("鋼廠未交"),"#,##0")%></span><span class="item-unit">噸</span></div>
      </div>
      <div class="grid-item">
        <div class="item-label">結存</div>
        <div><span class="item-val text-blue" style="color: #0056b3;"><%= aaTool.format(invData.get("結存"),"#,##0")%></span><span class="item-unit">噸</span></div>
      </div>
    </div>
  </div>
