...
<%
	...
	String formTarget = "bqjj008_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj008List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj008Tab"  style="height:100%">
<iframe name="bqjj008_<%=sessionId%>" id="bqjj008Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj008List.jsp"></iframe>
</div>
</de:form>
