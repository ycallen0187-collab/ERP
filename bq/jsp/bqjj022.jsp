...
<%! public static final String _AppId = "BQJJ022"; %>
<%
	String sessionId = dejcWebUtil.genUniqueId(session.getId()) ;
	String formTarget = "bqjj022_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj022List.jsp?_sessionId="+sessionId ;
%>
...
<de:form action="<%=formAction%>" target="<%=formTarget%>">
	<tr>
        ...
        <td class="subsys-title" width="8%">成品料號</td>
        <td width="12%" class="light-bg-left">
        	<de:text name="BMATNO" size="20"   />
        </td> 
        
        <td class="subsys-title" width="8%">原料料號</td>
        <td width="12%" class="light-bg-left">
        	<de:text name="RAWMATNO" size="20"   />
        </td> 
      ...
      <tr>  
        ...
        <td width="8%" class="light-bg-left">
			<de:select name="report_qry" src="de.Option" option="B=彙總;A=明細" hideValue="true"/>
		</td>
...
<div id="bqjj022Tab"  style="height:100%">
<iframe name="bqjj022_<%=sessionId%>" id="bqjj022Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj022List.jsp"></iframe>
</div>
</de:form>
