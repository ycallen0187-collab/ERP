...
<%
	...
	String formTarget = "bqjj024_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj024List.jsp?_sessionId="+sessionId ;
%>
...
<de:form action="<%=formAction%>" target="<%=formTarget%>">
	...
	<tr>      
        ...
        <td width="8%" class="light-bg-left">
			<de:select name="stockId_qry" src="de.Option" option="C=保稅廠;B=保稅委外廠;A=保稅外租倉庫" first="請選擇"   hideValue="true"/>
		</td>
...
<div id="bqjj024Tab"  style="height:100%">
<iframe name="bqjj024_<%=sessionId%>" id="bqjj024Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj024List.jsp"></iframe>
</div>
</de:form>
