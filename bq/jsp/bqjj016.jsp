...
<%! public static final String _AppId = "BQJJ016"; %>
<%
	String sessionId = dejcWebUtil.genUniqueId(session.getId()) ;
	String formTarget = "bqjj016_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj016List.jsp?_sessionId="+sessionId ;
%>
...
<de:form action="<%=formAction%>" target="<%=formTarget%>">
    ...
    <tr>   
        ...
        <td width="8%" class="light-bg-left">
			<de:select name="stockId_qry" src="de.Option" option="C=保稅廠;B=保稅委外廠" first="請選擇"   hideValue="true"/>
		</td>
...
<div id="bqjj016Tab"  style="height:100%">
<iframe name="bqjj016_<%=sessionId%>" id="bqjj016Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj016List.jsp"></iframe>
</div>
</de:form>
