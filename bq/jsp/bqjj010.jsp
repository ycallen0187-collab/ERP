...
<%
	...
	String formTarget = "bqjj010_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj010List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj010Tab"  style="height:100%">
<iframe name="bqjj010_<%=sessionId%>" id="bqjj010Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj010List.jsp"></iframe>
</div>
</de:form>
