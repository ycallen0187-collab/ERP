    ...
    <section class="dl1-section" id="dl1-sales">
      ...
      <div class="dl1-kpi-grid">
        <article class="dl1-kpi-card">
          <div class="dl1-kpi-topline"><span class="dl1-kpi-title">本月接單</span><span class="dl1-kpi-value"><%=aaTool.format(currOrder, "#,##0")%></span></div>
        ...
        <article class="dl1-kpi-card">
          <div class="dl1-kpi-topline"><span class="dl1-kpi-title">本月銷售重量</span><span class="dl1-kpi-value"><%= aaTool.format(salesQty, "#,##0") %></span></div>
