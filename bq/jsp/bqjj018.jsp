...
<%! public static final String _AppId = "BQJJ018"; %>
<%
	String sessionId = dejcWebUtil.genUniqueId(session.getId()) ;
	String formTarget = "bqjj018_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj018List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj018Tab"  style="height:100%">
<iframe name="bqjj018_<%=sessionId%>" id="bqjj018Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj018List.jsp"></iframe>
</div>
</de:form>
