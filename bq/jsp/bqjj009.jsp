...
<%! public static final String _AppId = "BQJJ009"; %>
<%
	String sessionId = dejcWebUtil.genUniqueId(session.getId()) ;
	String formTarget = "bqjj009_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj009List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj009Tab"  style="height:100%">
<iframe name="bqjj009_<%=sessionId%>" id="bqjj009Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj009List.jsp"></iframe>
</div>
</de:form>
