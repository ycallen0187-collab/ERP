...
<%! public static final String _AppId = "BQJJ001"; %>
<%
	String sessionId = dejcWebUtil.genUniqueId(session.getId()) ;
	String formTarget = "bqjj001_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj001List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj001Tab"  style="height:100%">
<iframe name="bqjj001_<%=sessionId%>" id="bqjj001Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj001List.jsp"></iframe>
</div>
</de:form>
