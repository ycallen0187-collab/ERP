...
<%! public static final String _AppId = "BQJJ014"; %>
<%
	String sessionId = dejcWebUtil.genUniqueId(session.getId()) ;
	String formTarget = "bqjj014_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj014List.jsp?_sessionId="+sessionId ;
%>
...
<de:form action="<%=formAction%>" target="<%=formTarget%>">
	<tr>
        ...
        <td width="20%" class="light-bg-left"><de:text name="matNo_qry" size="20"/></td>
        ...
        <td width="8%" class="light-bg-left">
			<de:select name="stockId_qry" src="de.Option" option="C=保稅廠;B=保稅委外廠;A=保稅外租倉庫"  />
		</td>
...
<div id="bqjj014Tab"  style="height:100%">
<iframe name="bqjj014_<%=sessionId%>" id="bqjj014Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj014List.jsp"></iframe>
</div>
</de:form>
