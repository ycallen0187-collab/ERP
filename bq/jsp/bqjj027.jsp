...
<%
	...
	String formTarget = "bqjj027_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj027List.jsp?_sessionId="+sessionId ;
...
<div id="bqjj027Tab"  style="height:100%">
<iframe name="bqjj027_<%=sessionId%>" id="bqjj027Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj027List.jsp"></iframe>	
</div>
</de:form>
...
function query() {
	if ( !deValidateInputData() ) { 
		...
		//ff.tabTable.show(document.all.bqjj027Tab);
		form1.submit() ;
	}
}
