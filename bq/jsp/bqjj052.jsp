...
<%
	...
	String formTarget = "bqjj052_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj052List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj052Tab"  style="height: calc(100vh);overflow: hidden;">
<iframe name="bqjj052_<%=sessionId%>" id="bqjj052Id" width="100%" height="100%" frameborder=0 src="/erp/bq/jsp/bqjj052List.jsp"></iframe>
</div>
</de:form>
