...
public String action(dsjccom dsCom, HttpServletRequest request)throws Exception{ 
	...
	try {
	    ...
	    if(isBoned.equals("Y")){
	    	...
	    	purpCode = "  IN ('D') ";
	    }else if(isBoned.equals("P")){
	    	purpCode = " IN ('P') ";
	    }else if(isBoned.equals("")){
	    	purpCode = " IN ('B','D','P') ";
	    }
		
		long startTime = System.currentTimeMillis();
		new agjcbdT1PDAO(dsCom, con).qryDatas_Y(matNo, begDate, endDate,purpCode,stockId,bondeb_bDate);
...
try{
	...
	if(stockId.equals("C")){
		rptRSUrl.put("A", "MP002/BQJJ002PY");
		rptRSUrl.put("B", "MP002/BQJJ002PYG");
		
	}else if(stockId.equals("B")){	
		rptRSUrl.put("A", "MP002/BQJJ002PBY");
		rptRSUrl.put("B", "MP002/BQJJ002PBYG");
	}
