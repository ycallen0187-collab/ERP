...
<%! public static final String _AppId = "BQJJ032"; %>
<%
	String sessionId = dejcWebUtil.genUniqueId(session.getId()) ;
	String formTarget = "bqjj0321_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj0321.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj0321Tab"  style="height:100%">
<iframe name="bqjj0321_<%=sessionId%>" id="bqjj0321Id" width="100%" height="90%" frameborder=0 
	src="http://172.17.0.29:3000/d/52338287-9e7d-44f6-aba1-e8ce8736599f/01-e7949f-e7aea1-e983a8-lv1e79c8b-e69dbf?orgId=1&from=now%2FM&to=now%2FM&timezone=browser&kiosk">
</iframe>
</div>
