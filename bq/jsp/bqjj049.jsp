...
<%
	...
	String formTarget = "bqjj049_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj049List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj049Tab"  style="height: calc(100vh);overflow: hidden;">
<iframe name="bqjj049_<%=sessionId%>" id="bqjj049Id" width="100%" height="100%" frameborder=0 src="/erp/bq/jsp/bqjj049List.jsp"></iframe>
</div>
</de:form>
