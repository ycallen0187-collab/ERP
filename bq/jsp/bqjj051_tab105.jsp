...
<%@ page import="com.icsc.bq.core.bqjc042105" %>
...
<%
    ...
    bqjc042105 bq042105 = new bqjc042105(_dsCom);
    Map dashboardData = bq042105.getDashboardData105(_dsCom, request);
    
    Map showData = (Map) (dashboardData != null ? dashboardData.get("105Data") : new HashMap());
...
%>
  ...
  <div class="dl2-wrap">
   <div style="display: flex; justify-content: center; font-size: 32px; color: red;">開發中！！！</div>
    <header class="dl2-hero">
      <div class="dl2-meta-row">
        <p class="dl2-eyebrow">105廠∣製造課 + 加工課</p>
    ...
    <section class="dl2-section">
      ...
      <div class="dl2-dept-grid">
        <article class="dl2-dept-card" style="margin-bottom:8px;">
         ...
         <div class="dl2-metric-row" style="display:none;"><span>目標產量</span><strong style="color:var(--dl2-purple)"><%= showData.get("目標產量") %>MT</strong></div>   
        ...
        <article class="dl2-dept-card">
         ...
         <div class="dl2-metric-row" style="display:none;"><span>目標酸洗總量</span><strong style="color:var(--dl2-red)"><%= showData.get("目標酸洗總量") %>MT</strong></div>
        ...
        <small>加工 / 酸洗 </small>
		 ...
		 <article class="dl2-kpi-card" style="margin-top:8px">
		    ...
		    %>
		      ...
		      <section class="dl2-section" id="dl2-downtime" style="display:none;">
		      <div class="dl2-section-title">
		        <h2>設備停機分析</h2>
		        <small>小時 / 佔比</small>
		      </div>
  ...
  <section class="dl2-section" id="dl2-people">
      ...
      <article class="dl2-people-card" style="margin-top:8px">
        ...
        <div class="dl2-people-row"><span>台籍 / 土籍總計</span><b><%= showData.get("台籍總人數") %> / <%= showData.get("土籍總人數") %></b></div>
      </article>
      <div class="dl2-people-grid">
        <article class="dl2-people-card">
          <p class="dl2-label">廠務人力</p>
          <strong><%= showData.get("廠務總人數") %>人</strong>
          <p class="dl2-sub">台籍 <%= showData.get("廠務台籍人數") %> / 土籍 <%= showData.get("廠務土籍人數") %></p>
        </article>
        <article class="dl2-people-card">
          <p class="dl2-label">生管成品人力</p>
          <strong style="color:var(--dl2-teal)"><%= showData.get("生管成品總人數") %> 人</strong>
          <p class="dl2-sub">台籍 <%= showData.get("生管成品台籍人數") %> / 土籍 <%= showData.get("生管成品土籍人數") %></p>
        </article>
      </div>
      <div class="dl2-people-grid">
        <article class="dl2-people-card">
          ...
          <p class="dl2-sub">台籍 <%= showData.get("製造台籍人數") %> / 土籍 <%= showData.get("製造土籍人數") %></p>
        </article>
        <article class="dl2-people-card">
          <p class="dl2-label">加工課人力</p>
          <strong style="color:var(--dl2-teal)"><%= showData.get("加工總人數") %> 人</strong>
          <p class="dl2-sub">台籍 <%= showData.get("加工台籍人數") %> / 土籍 <%= showData.get("加工土籍人數") %></p>
        </article>
      </div>
      <div class="dl2-people-grid">
        <article class="dl2-people-card">
          ...
          <p class="dl2-sub">台籍 <%= showData.get("設備台籍人數") %> / 土籍 <%= showData.get("設備土籍人數") %></p>
        </article>
        <article class="dl2-people-card">
          <p class="dl2-label">其他人力</p>
          <strong style="color:var(--dl2-teal)"><%= showData.get("其他總人數") %> 人</strong>
          <p class="dl2-sub">台籍 <%= showData.get("其他台籍人數") %> / 土籍 <%= showData.get("其他土籍人數") %></p>
        </article>
      </div>
