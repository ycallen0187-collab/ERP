...
<%
	...
	String formTarget = "bqjj031_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj031List.jsp?_sessionId="+sessionId ;
%>
...
<de:form action="<%=formAction%>" target="<%=formTarget%>">
	<tr>
        <td class="subsys-title" width="8%">出貨日期</td>
        <td width="30%"  class="light-bg-left">
        	<de:text type="dateNew" fmt="W" name="begDate_qry" size="8" />~
        	<de:text type="dateNew" fmt="W" name="endDate_qry" size="8" />
        </td>
...
<div id="bqjj031Tab"  style="height:100%">
<iframe name="bqjj031_<%=sessionId%>" id="bqjj031Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj031List.jsp"></iframe>
</div>
</de:form>
