...
<%
	...
	String formTarget = "bqjj013_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj013List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj013Tab"  style="height:100%">
<iframe name="bqjj013_<%=sessionId%>" id="bqjj013Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj013List.jsp"></iframe>
</div>
</de:form>
