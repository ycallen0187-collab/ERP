...
<%@ page import="com.icsc.bq.core.bqjc042108" %>
...
<%
    ...
    bqjc042108 bq042108 = new bqjc042108(_dsCom);
    Map dashboardData = bq042108.getDashboardData108(_dsCom, request);
    
    Map showData = (Map) (dashboardData != null ? dashboardData.get("108Data") : new HashMap());
  ...
  <div style="display: flex; justify-content: center; font-size: 32px; color: red;">開發中！！！</div>
    <header class="xz-hero">
      <div class="xz-meta-row">
        <p class="xz-eyebrow">108廠∣製造課 + 加工課</p>
      ...
      <div class="xz-dept-grid">
        ...
        <article class="xz-dept-card">
         ...
         <div class="xz-metric-row"><span>加工產量</span><strong style="color:var(--xz-red)"><%= showData.get("加工產量") %> t</strong></div>
          ...
          <div class="xz-metric-row" style="display:none;"><span>可用噴槍庫存</span><strong style="color:var(--xz-green)"><%= aaTool.format(showData.get("可用噴槍庫存"),"#,##0") %></strong></div>
...
%>
    ...
    <section class="xz-section" id="xz-downtime" style="display:none;">
      <div class="xz-section-title">
        <h2>設備停機分析</h2>
        <small>小時 / 佔比</small>
      </div>
...
%>
  ...
  <section class="xz-section" id="xz-people">
      <div class="xz-section-title">
        ...
        <div class="xz-people-row"><span>台籍 / 土籍總計</span><b><%= showData.get("台籍總人數") %> / <%= showData.get("土籍總人數") %></b></div>
      ...
      <div class="xz-people-grid">
        <article class="xz-people-card">
          ...
          <p class="xz-sub">台籍 <%= showData.get("廠務台籍人數") %> / 土籍 <%= showData.get("廠務土籍人數") %></p>
        </article>
        <article class="xz-people-card">
          <p class="xz-label">生管成品人力</p>
          <strong style="color:var(--xz-teal)"><%= showData.get("生管成品總人數") %> 人</strong>
          <p class="xz-sub">台籍 <%= showData.get("生管成品台籍人數") %> / 土籍 <%= showData.get("生管成品土籍人數") %></p>
        </article>
      </div>
            <div class="xz-people-grid">
        <article class="xz-people-card">
          ...
          <p class="xz-sub">台籍 <%= showData.get("製造台籍人數") %> / 土籍 <%= showData.get("製造土籍人數") %></p>
        </article>
        <article class="xz-people-card">
          <p class="xz-label">加工課人力</p>
          <strong style="color:var(--xz-teal)"><%= showData.get("加工總人數") %> 人</strong>
          <p class="xz-sub">台籍 <%= showData.get("加工台籍人數") %> / 土籍 <%= showData.get("加工土籍人數") %></p>
        </article>
      </div>
            <div class="xz-people-grid">
        <article class="xz-people-card">
          ...
          <p class="xz-sub">台籍 <%= showData.get("設備台籍人數") %> / 土籍 <%= showData.get("設備土籍人數") %></p>
        </article>
        <article class="xz-people-card">
          <p class="xz-label">其他課人力</p>
          <strong style="color:var(--xz-teal)"><%= showData.get("其他總人數") %> 人</strong>
          <p class="xz-sub">台籍 <%= showData.get("其他台籍人數") %> / 土籍 <%= showData.get("其他土籍人數") %></p>
        </article>
      </div>
