...
<%
	...
	String formTarget = "bqjj051_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj051List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj051Tab"  style="height: calc(100vh);overflow: hidden;">
<iframe name="bqjj051_<%=sessionId%>" id="bqjj051Id" width="100%" height="100%" frameborder=0 src="/erp/bq/jsp/bqjj051List.jsp"></iframe>
</div>
</de:form>
