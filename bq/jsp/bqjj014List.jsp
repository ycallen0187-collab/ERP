<%@page import="com.icsc.ag.core.agjcB08Core"%>
...
public String action(dsjccom dsCom, HttpServletRequest request)throws Exception{ 
	...
	try {
		...
		if(stockId.equals("B")){
			new agjcB08Core(dsCom, con).qryDatas_P(matNo, begDate, endDate, purpCode, stockId, bonded_bDate);
		}else if(stockId.equals("C")){
			new agjcbdT1PDAO(dsCom, con).qryDatas_P(matNo, begDate, endDate,purpCode,stockId,bonded_bDate);
		}else if(stockId.equals("A")){
			new agjcB08Core(dsCom, con).qryDatas_P(matNo, begDate, endDate, purpCode, stockId, bonded_bDate);
		}
...
try{
	...
	if(stockId.equals("C")){
		rptUrl.append(domain + "MP002/BQJJ002P");
	}else if(stockId.equals("B")){	
		rptUrl.append(domain + "MP002/BQJJ002PB");
	}else if(stockId.equals("A")){	
		rptUrl.append(domain + "MP002/BQJJ002PA");
	}
