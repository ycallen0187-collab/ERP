...
<%! public static final String _AppId = "BQJJ003"; %>
<%
	String sessionId = dejcWebUtil.genUniqueId(session.getId()) ;
	String formTarget = "bqjj003_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj003List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj003Tab"  style="height:100%">
<iframe name="bqjj003_<%=sessionId%>" id="bqjj003Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj003List.jsp"></iframe>
</div>
</de:form>
