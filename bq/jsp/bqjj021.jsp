...
<%
	...
	String formTarget = "bqjj021_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj021List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj021Tab"  style="height:100%">
<iframe name="bqjj021_<%=sessionId%>" id="bqjj021Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj021List.jsp"></iframe>
</div>
</de:form>
