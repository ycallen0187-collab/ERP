...
<%! public static final String _AppId = "BQJJ005"; %>
<%
	String sessionId = dejcWebUtil.genUniqueId(session.getId()) ;
	String formTarget = "bqjj005_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj005List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj005Tab"  style="height:100%">
<iframe name="bqjj005_<%=sessionId%>" id="bqjj005Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj005List.jsp"></iframe>
</div>
</de:form>
