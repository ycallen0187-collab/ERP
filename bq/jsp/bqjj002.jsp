...
<%! public static final String _AppId = "BQJJ002"; %>
<%
	String sessionId = dejcWebUtil.genUniqueId(session.getId()) ;
	String formTarget = "bqjj002_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj002List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj002Tab"  style="height:100%">
<iframe name="bqjj002_<%=sessionId%>" id="bqjj002Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj002List.jsp"></iframe>
</div>
</de:form>
