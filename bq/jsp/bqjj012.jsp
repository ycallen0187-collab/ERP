...
<%! public static final String _AppId = "BQJJ012"; %>
<%
	String sessionId = dejcWebUtil.genUniqueId(session.getId()) ;
	String formTarget = "bqjj012_"+sessionId ;
	String formAction = "/erp/bq/jsp/bqjj012List.jsp?_sessionId="+sessionId ;
%>
...
<div id="bqjj012Tab"  style="height:100%">
<iframe name="bqjj012_<%=sessionId%>" id="bqjj012Id" width="100%" height="90%" frameborder=0 src="/erp/bq/jsp/bqjj012List.jsp"></iframe>
</div>
</de:form>
